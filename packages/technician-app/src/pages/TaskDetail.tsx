...
export default function TaskDetail() {
  ...
  const complete = useMutation({ mutationFn: () => api.patch(`/tasks/${id}/complete`, { notes: completeNotes }), onSuccess: () => { toast.success(t('common.success')); navigate('/queue'); } });
  const postpone = useMutation({ mutationFn: () => api.patch(`/tasks/${id}/postpone`, { reason: postponeReason, newDate: postponeDate || undefined }), onSuccess: () => { toast.success(t('common.success')); navigate('/queue'); } });
