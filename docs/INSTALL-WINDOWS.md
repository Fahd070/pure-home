# Pure Home — Windows Installation Guide

Version 1.0.0 | For employee PCs
...
- Internet connection
- The Pure Home installer file: `Pure-Home-Setup-1.0.0.exe`
...
Double-click `Pure-Home-Setup-1.0.0.exe`.
...
- Leave the installation directory as the default (`C:\Program Files\Pure Home`)
- Click **Install**
- Click **Finish** when complete

The app will appear in the Start Menu as **Pure Home** and on the Desktop.
...
1. Download the new `Pure-Home-Setup-X.X.X.exe` installer
2. Run it — it will automatically replace the previous version
...
2. Search for "Pure Home"
3. Click **Uninstall**

**Option B — Control Panel:**
1. Open Control Panel → Programs → Uninstall a program
2. Find "Pure Home" in the list
3. Click **Uninstall**
...
| Item | Location |
|---|---|
| App files | `C:\Program Files\Pure Home\` |
| App data & settings | `C:\ProgramData\Pure Home\` |
| Log files | `C:\ProgramData\Pure Home\logs\` |
...
1. Close the app
2. Delete the folder `C:\ProgramData\Pure Home\`
...
- The log files from `C:\ProgramData\Pure Home\logs\`
